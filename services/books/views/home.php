...
<div class="container">
  ...
  <div class="stat-item available">
    ...
    <span id="books-available" data-label="livros disponíveis">Carregando...</span>
  </div>
  <div class="stat-item borrowed">
    <i class="fas fa-book"></i>
    <span id="books-borrowed" data-label="emprestados">Carregando...</span>
  </div>
</div>
    ...
    <script src="/public/js/books-loader.js"></script>
