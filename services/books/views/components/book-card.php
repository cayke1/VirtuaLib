...
<div class="book-card" data-book-id="<?php echo $book['id']; ?>">
    ...
    <div class="book-actions">
        <?php if ($buttonClass === 'return'): ?>
            <button class="action-button <?php echo $buttonClass; ?>" data-book-id="<?php echo $book['id']; ?>" <?php echo $buttonDisabled ? 'disabled' : ''; ?> onclick="returnBook(<?php echo $book['id']; ?>)">
                <?php echo $buttonLabel; ?>
            </button>
        <?php else: ?>
            <button class="action-button <?php echo $buttonClass; ?>" data-book-id="<?php echo $book['id']; ?>" <?php echo $buttonDisabled ? 'disabled' : ''; ?> onclick="requestBook(<?php echo $book['id']; ?>)">
                <?php echo $buttonLabel; ?>
            </button>
        <?php endif; ?>
