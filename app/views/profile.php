                        ...
                        <div class="section-content">
                            <div class="info-grid">
                                <div class="info-item">
                                    ...
                                    <p class="info-value" id="info-name">Carregando...</p>
                                </div>
                                <div class="info-item">
                                    <label class="info-label">E-mail</label>
                                    <p class="info-value" id="info-email">carregando@email.com</p>
                                </div>
                                <div class="info-item">
                                    <label class="info-label">Tipo de Conta</label>
                                    <p class="info-value" id="info-role">Usuário</p>
                                </div>
                                <div class="info-item">
                                    <label class="info-label">Membro desde</label>
                                    <p class="info-value" id="info-created">Carregando...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="activity-list" id="activity-list">
                                <div class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <p class="activity-text">Carregando atividades...</p>
